...
struct SparseMatrix
{
   ...
   //funciones para rellenar la matriz, set element para cada valor ya calculado o add_to_element lo de la jacobiana de incrementar valores (mejor para no liarla)
...
{
   unsigned int n; // dimension El tamaño de la matriz, de cada lado
   std::vector<T> value; // nonzero values row by row (5 por fila, 3 en 1D)
